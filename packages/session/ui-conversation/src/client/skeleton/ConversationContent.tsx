...
function WidthHandle(props: {
  ...
  return (
    <div
      {...styling.props(styles.widthHandle)}
...
export function ConversationContent({
  ...
  const heroWorkspaceRow = (
    <div {...styling.props(styles.heroWorkspaceRow)}>
      <WorkspaceChip
  ...
  const composerBar = (
    <div {...styling.props(styles.composerStack, hero && styles.composerHero)}>
  ...
  const composerSeat = (
    <div ref={seatResizeRef} {...styling.props(styles.composerSeat)} data-composer-seat="">
      {composer}
    </div>
  );
  ...
  return (
    <div {...styling.props(styles.body)}>
      <div {...styling.props(styles.scrollBody)} data-conversation-scroll="">
