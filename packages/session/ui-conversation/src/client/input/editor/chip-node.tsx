...
export class ReferenceChipNode extends DecoratorNode<JSX.Element> {
   ...
   */
  constructor(
    insert: Omit<ReferenceInsert, "appearance"> & { appearance?: ReferenceInsert["appearance"] },
    invalid = false,
    key?: NodeKey,
  ) {
    super(key);
  ...
  override decorate(): JSX.Element {
    return (
      <ReferenceChip label={this.__label} appearance={this.__appearance} invalid={this.__invalid} />
    );
  }
}
 ...
 */
export function $isReferenceChipNode(
  node: LexicalNode | null | undefined,
): node is ReferenceChipNode {
