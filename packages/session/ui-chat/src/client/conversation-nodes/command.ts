...
function compactSummary(
  match: ConversationMatch | undefined,
  checkpoint: ConversationMatch,
): CompactionSummaryNode {
...
export const commandDefinition: ConversationNodeDefinition<CommandState> = {
  ...
  buildViewNode: (context) => {
    ...
    const compaction =
      state.checkpoint === undefined ? null : compactSummary(state.summary, state.checkpoint);
