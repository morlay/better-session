...
import { styles } from "./ContextInjectionRow.styles.ts";
...
export function ContextInjectionRow({
  ...
  return (
    <DisclosureRow
      className={styling.className(styles.root)}
      icon={
        producer.role === "recall" ? (
          <span data-context-recall-icon>
            <ReferenceIcon kind="session" />
          </span>
        ) : (
      ...
      collapsedContent={
        producer.label === null ? undefined : (
          ...
          <>
            ...
            <span {...styling.props(styles.source)} data-context-source>
              {producer.label}
            </span>
            {summary !== null && (
              <>
                <span {...styling.props(styles.sep)} aria-hidden />
                <span {...styling.props(styles.summary)} data-context-summary>
                  {summary}
                </span>
              </>
            )}
