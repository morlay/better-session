...
import { styles } from "./AssistantMarkdown.styles.ts";
...
export const AssistantMarkdown = memo(function AssistantMarkdown({
  ...
  return (
    <div {...styling.props(styles.root)} data-streaming={streaming || undefined}>
      <div {...styling.props(styles.body)}>
        {rendered}
        {interrupted && <span {...styling.props(styles.stopped)}>{t("message.stopped")}</span>}
      </div>
    </div>
  );
});
