...
import { styles } from "./TurnUsagePanel.styles.ts";
...
export function TurnUsagePanel({ usage, t }: TurnUsagePanelProps) {
  ...
  return (
    <span ref={rootRef} {...styling.props(styles.root)} data-turn-usage-root="">
      <button
        type="button"
      ...
      >
        ...
        <span {...styling.props(styles.label)} data-turn-usage-label="">
        ...
        createPortal(
          ...
          >
            <div {...styling.props(dialogStyles.title)}>
              ...
              <span {...styling.props(dialogStyles.titleValue)}>
                {formatExactCount(usage.totalTokens, t)}
              </span>
            </div>
            <div {...styling.props(dialogStyles.titleRule)} aria-hidden />
            <dl {...styling.props(dialogStyles.details)} data-turn-usage-details>
              {routes !== "" && (
                <>
              ...
              <dd>
                ...
                {usage.reasoningTokens !== undefined && (
                  <span {...styling.props(dialogStyles.reasoning)}>
                    {t("message.turnUsage.reasoning", {
                      tokens: formatExactCount(usage.reasoningTokens, t),
                    })}
                  </span>
                )}
              </dd>
      ...
      {open &&
        createPortal(
          ...
          >
            ...
            <div {...styling.props(dialogStyles.titleRule)} aria-hidden />
            <dl {...styling.props(dialogStyles.details)} data-turn-time-details>
